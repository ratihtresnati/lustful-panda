...
public class PlayerControllerLama : MonoBehaviour
{
    ...
    private CharacterAnimatorControllerStateLama _characterAnimator;
    ...
    void Update()
    {
        ...
        if (!IsCatch)
        {
            ...
            if (scriptLama) UpdateAnimations();
    ...
    */
    ...
    {
        // Idle / Walk / Run
        if (Move != Vector3.zero && isGrounded && !IsRooling && !IsJump)
        {
            if (IsRun)
            {
